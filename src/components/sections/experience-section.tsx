...
export function ExperienceSection() {
  ...
  return (
    <section id="experience" className="relative w-full min-h-screen flex flex-col justify-center py-16 md:py-24 bg-background text-foreground border-t border-border/40 overflow-hidden">
